...
- TO-Toolbox (or alternatively, my folder with the premade built executable [CaballaRE>bin>Debug>CaballaRE.exe])
- TNT (or alternatively, my folder with a runnable .bat pre-made for you)
- My run_bulk4.bat (preferably, but you don't have to if you know how to use TNT already or you follow my setup steps in this thread)
- Photoshop
- My "setup" action for Photoshop (preferably, but you can do it the manual way if you want to!)
